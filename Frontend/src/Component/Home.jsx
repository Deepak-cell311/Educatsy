    ...
    <div className="w-screen relative flex flex-col items-center justify-center bg-gray-900 overflow-hidden text-white">
      {/* {
        authUser ? (
          <button 
            onClick={logout} 
            className="absolute top-14 right-20 z-50 bg-red-500 py-2 px-4 rounded-xl text-gray-900 text-3xl">
            LogOut
          </button>
        ) : (
          <button className="absolute top-14 right-20 z-50 bg-yellow-500 py-2 px-4 rounded-xl text-gray-900 text-3xl">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-8 py-4">
          {/* Course Boxes */}
          {
          // [{ img: html, title: "HTML", description: "HTML is the standard markup language for Web pages. With HTML you can create your own Website. HTML is easy to learn!" },
          // { img: css, title: "CSS", description: "CSS is the language we use to style an HTML document. CSS describes how HTML elements should be displayed." },
          // { img: js, title: "JavaScript", description: "JavaScript is the world's most popular programming language, primarily used for the Web." },
          // { img: node, title: "NodeJs", description: "Node.js is an open-source, cross-platform runtime environment for running web applications outside the client's browser." },
          // { img: mongodb, title: "MongoDB", description: "MongoDB is a document database. It stores data in a type of JSON format called BSON." },
          // { img: express, title: "Express Js", description: "Express is a fast, minimalist web framework for Node.js, providing a robust set of features for web applications." }
          // ]
          courses.map((course, index) => (
            <div key={index} className="boxes bg-gray-300 shadow-inner shadow-gray-900 text-black py-10 px-20 hover:scale-105">
